...
function register_acf_block_types() {
  ...
  acf_register_block_type(array(
      ...
      'render_template'   => 'blocks/content-columns.php',
      'category'          => 'layout',
      'icon'              => 'book-alt',
  ...
  acf_register_block_type(array(
    'name'              => 'text-box',
    'title'             => __('text-box'),
    'description'       => __('A custom text box block.'),
    'render_template'   => 'blocks/text-box.php',
    'category'          => 'layout',
    'icon'              => 'book-alt',
    'keywords'          => array( 'txt box block', 'quote' ),
  ));
    ...
    acf_register_block_type(array(
      'name'              => 'text-box2',
      'title'             => __('text-box2'),
      'description'       => __('A custom text box2 block.'),
      'render_template'   => 'blocks/text-box2.php',
      'category'          => 'layout',
      'icon'              => 'book-alt',
      'keywords'          => array( 'txt box2 block', 'quote' ),
    ));
}
